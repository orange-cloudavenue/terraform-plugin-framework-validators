...
var _ validator.Int32 = attributeIsDivisibleByAnInteger{}
...
func (validator attributeIsDivisibleByAnInteger) ValidateInt32(
	ctx context.Context,
	...
	var attributeValue types.Int32
	...
	if attributeValue.ValueInt32()%req.ConfigValue.ValueInt32() != 0 {
		res.Diagnostics.AddAttributeError(
			paths[0],
			"Invalid configuration",
...
*/
func AttributeIsDivisibleByAnInteger(path path.Expression) validator.Int32 {
